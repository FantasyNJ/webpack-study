...
var a = 1235;
/* harmony default export */ var type = (a);

// EXTERNAL MODULE: ./src/1.jpg
...
new footer(root);
var huaji = new Image();
huaji.src = _1_default.a;
huaji.classList.add('huaji'); // huaji.classList.add(style.huaji)
...
var dom = $('<div>');
dom.html(lodash_default.a.join(['dell', 'lee']), ' ');
$('body').append(dom);
console.log(undefined); //  不指向window，如果想指向window就要使用import-loader
...
module.exports = __webpack_require__.p + "images/1_6fa239f39d20ee5def6ead28f680feb1.jpg";
...
/******/ });
//# sourceMappingURL=main.c132216b35f1cad6ae42.js.map